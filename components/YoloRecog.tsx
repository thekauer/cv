...
export const YoloRecog = () => {
  ...
  return (
    <StyledYoloRecog>
      <DrawResult>
        ...
        <Result className={loading ? "visible" : "hidden"}>
          <Loader
            ...
            className={displayLoadingAnim ? "loader visible" : "loader hidden"}
          />
      ...
      <ButtonContainer>
        <YoloButton onClick={erease}>{t("erase")}</YoloButton>
        <YoloButton onClick={send}>{t("send")}</YoloButton>
      </ButtonContainer>
    </StyledYoloRecog>
  );
};
